...
const THEMES = {
  ...
  barcelona: {
    ...
    bg: "#f0f4fa",
    surface: "#ffffff",
    headerBg: "linear-gradient(135deg,#004D98 0%,#A50044 100%)",
    headerText: "white",
    chipBg: "#A50044",
    font: "Roboto,sans-serif",
    title: "Llista del Barça! 🔵🔴",
    icon: "⚽",
  },
};
...
const EMOJIS = {
  // Dairy
  milk:"🥛",leche:"🥛",llet:"🥛",butter:"🧈",mantequilla:"🧈",
  mantega:"🧈",cheese:"🧀",queso:"🧀",formatge:"🧀",yogurt:"🥛",
  yogur:"🥛",iogurt:"🥛",cream:"🫙",nata:"🫙",egg:"🥚",eggs:"🥚",
  huevo:"🥚",huevos:"🥚",ou:"🥚",ous:"🥚",
  // Bread & Bakery
  bread:"🍞",pan:"🍞",pa:"🍞",baguette:"🥖",croissant:"🥐",
  brioche:"🥐",toast:"🍞",tostada:"🍞",flour:"🌾",harina:"🌾",
  farina:"🌾",
  // Fruit
  apple:"🍎",manzana:"🍎",poma:"🍎",banana:"🍌",plátano:"🍌",
  plàtan:"🍌",orange:"🍊",naranja:"🍊",taronja:"🍊",
  mandarin:"🍊",mandarina:"🍊",mandarines:"🍊",lemon:"🍋",
  limón:"🍋",llimona:"🍋",strawberry:"🍓",fresa:"🍓",
  maduixa:"🍓",grape:"🍇",grapes:"🍇",uva:"🍇",uvas:"🍇",
  raïm:"🍇",watermelon:"🍉",sandía:"🍉",síndria:"🍉",
  melon:"🍈",melón:"🍈",meló:"🍈",peach:"🍑",melocotón:"🍑",
  préssec:"🍑",pear:"🍐",pera:"🍐",cherry:"🍒",cereza:"🍒",
  cirera:"🍒",mango:"🥭",pineapple:"🍍",piña:"🍍",
  pinya:"🍍",kiwi:"🥝",fig:"🍈",higo:"🍈",figa:"🍈",
  pomelo:"🍊",avocado:"🥑",aguacate:"🥑",alvocat:"🥑",
  // Vegetables
  tomato:"🍅",tomate:"🍅",tomàquet:"🍅",potato:"🥔",
  patata:"🥔",patates:"🥔",onion:"🧅",cebolla:"🧅",
  ceba:"🧅",garlic:"🧄",ajo:"🧄",all:"🧄",carrot:"🥕",
  zanahoria:"🥕",pastanaga:"🥕",pepper:"🫑",pimiento:"🫑",
  pebre:"🫑",cucumber:"🥒",pepino:"🥒",cogombre:"🥒",
  zucchini:"🥒",calabacín:"🥒",carbassó:"🥒",eggplant:"🍆",
  berenjena:"🍆",albergínia:"🍆",broccoli:"🥦",brócoli:"🥦",
  bròquil:"🥦",lettuce:"🥬",lechuga:"🥬",enciam:"🥬",
  spinach:"🥬",espinaca:"🥬",espinacs:"🥬",mushroom:"🍄",
  champiñon:"🍄",bolet:"🍄",seta:"🍄",corn:"🌽",maíz:"🌽",
  blat:"🌽",asparagus:"🥦",espárrago:"🥦",esparrec:"🥦",
  celery:"🥬",apio:"🥬",api:"🥬",leek:"🥬",puerro:"🥬",
  porro:"🥬",cauliflower:"🥦",coliflor:"🥦",
  // Meat & Fish
  chicken:"🍗",pollo:"🍗",pollastre:"🍗",beef:"🥩",carne:"🥩",
  vedella:"🥩",veal:"🥩",ternera:"🥩",pork:"🥩",cerdo:"🥩",
  porc:"🥩",lamb:"🥩",cordero:"🥩",xai:"🥩",
  sausage:"🌭",salchicha:"🌭",salsitxa:"🌭",chorizo:"🌭",
  ham:"🥩",jamón:"🥩",pernil:"🥩",bacon:"🥓",
  fish:"🐟",pescado:"🐟",peix:"🐟",salmon:"🐟",salmón:"🐟",
  tuna:"🐟",atún:"🐟",tonyina:"🐟",shrimp:"🦐",
  gamba:"🦐",gambas:"🦐",squid:"🦑",calamar:"🦑",
  mussels:"🦪",mejillones:"🦪",musclos:"🦪",
  // Pantry
  rice:"🍚",arroz:"🍚",arròs:"🍚",pasta:"🍝",
  noodles:"🍝",fideos:"🍝",fideus:"🍝",lentils:"🫘",
  lenteja:"🫘",llenties:"🫘",chickpeas:"🫘",garbanzo:"🫘",
  cigró:"🫘",beans:"🫘",judía:"🫘",mongeta:"🫘",
  oil:"🫙",aceite:"🫙",oli:"🫙",vinegar:"🫙",
  vinagre:"🫙",sugar:"🍬",azúcar:"🍬",sucre:"🍬",
  salt:"🧂",sal:"🧂",pepper_spice:"🧂",pimienta:"🧂",
  tomato_sauce:"🥫",tomate_frito:"🥫",sofregit:"🥫",
  can:"🥫",lata:"🥫",conserva:"🥫",broth:"🍲",
  caldo:"🍲",brou:"🍲",honey:"🍯",miel:"🍯",mel:"🍯",
  jam:"🍯",mermelada:"🍯",melmelada:"🍯",
  // Drinks
  water:"💧",agua:"💧",aigua:"💧",juice:"🧃",zumo:"🧃",
  suc:"🧃",soda:"🥤",refresco:"🥤",coffee:"☕",café:"☕",
  cafè:"☕",tea:"🍵",té:"🍵",te:"🍵",beer:"🍺",
  cerveza:"🍺",cervesa:"🍺",wine:"🍷",vino:"🍷",vi:"🍷",
  milk_drink:"🥛",horchata:"🥛",
  // Snacks & Sweets
  chocolate:"🍫",chips:"🥔",crisps:"🥔",patatas_fritas:"🥔",
  cookies:"🍪",galleta:"🍪",galeta:"🍪",cake:"🎂",
  tarta:"🎂",pastís:"🎂",ice_cream:"🍦",helado:"🍦",
  gelat:"🍦",candy:"🍬",caramelo:"🍬",caramel:"🍬",
  cereal:"🥣",granola:"🥣",nuts:"🥜",frutos_secos:"🥜",
  fruits_secs:"🥜",almond:"🥜",almendra:"🥜",ametlla:"🥜",
  // Frozen & Prepared
  pizza:"🍕",soup:"🍲",sopa:"🍲",frozen:"🧊",
  congelado:"🧊",congelat:"🧊",
  // Dairy alternatives
  tofu:"🥡",soy:"🫘",soja:"🫘",
  // Household
  soap:"🧼",jabón:"🧼",sabó:"🧼",shampoo:"🧴",
  conditioner:"🧴",paper:"🧻",toilet:"🧻",papel:"🧻",
  paper_wc:"🧻",kitchen_roll:"🧻",cleaning:"🧹",
  limpiador:"🧹",detergent:"🫧",detergente:"🫧",
  bleach:"🫧",lejía:"🫧",lleixiu:"🫧",
  // Baby & Health
  diapers:"👶",pañal:"👶",bolquer:"👶",
  // Misc
  cafe:"☕",bread_roll:"🥖",pa_de_motlle:"🍞",
};
